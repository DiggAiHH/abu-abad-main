const dashboard = {
  ...
  materialsLink: 'Documents',
  myBookedAppointments: 'Mes rendez-vous réservés',
  noAppointmentsBooked: 'Aucun rendez-vous réservé',
  bookAppointment: 'Prendre un rendez-vous',
  availableAppointments: 'Rendez-vous disponibles',
  ...
  welcomeDoctor: 'Bienvenue, Dr. {{name}} !',
