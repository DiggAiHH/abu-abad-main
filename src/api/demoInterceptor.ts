...
function demoAppointments(userId: string): unknown[] {
  ...
  return [
    ...
    },
    {
      ...
      appointmentType: 'video',
      therapist: { firstName: 'Sarah', lastName: 'Müller' },
      patient: { firstName: 'Anna', lastName: 'Schmidt' },
      therapistNotes: 'Guter Fortschritt bei der Angstbewältigung.',
    },
  ];
}
  ...
  return [
    {
      ...
      content:
        'Guten Tag Herr Mustermann, bitte bringen Sie zum nächsten Termin Ihre aktuelle Medikamentenliste mit.',
      read: !isTherapist,
      createdAt: new Date(Date.now() - 7200000).toISOString(),
      sender: { firstName: 'Dr. Sarah', lastName: 'Müller' },
      receiver: { firstName: 'Max', lastName: 'Mustermann' },
    },
    {
      id: 'msg-2',
      senderId: patientId,
      ...
      content:
        'Vielen Dank, Frau Dr. Müller! Ich bringe alles mit. Darf ich vorab noch eine Frage stellen?',
      read: true,
      createdAt: new Date(Date.now() - 3600000).toISOString(),
      sender: { firstName: 'Max', lastName: 'Mustermann' },
      receiver: { firstName: 'Dr. Sarah', lastName: 'Müller' },
    },
    {
      id: 'msg-3',
      senderId: therapistId,
      receiverId: patientId,
      content: 'Natürlich, fragen Sie gerne!',
      read: !isTherapist,
    ...
    },
    {
      ...
      senderId: patientId,
      receiverId: therapistId,
      content: 'Ich habe seit 2 Tagen leichte Kopfschmerzen nach dem Sertralin. Ist das normal?',
      read: true,
    ...
    },
    {
      ...
      receiverId: patientId,
      content:
        'Das kann in den ersten Wochen vorkommen. Trinken Sie ausreichend Wasser und melden Sie sich, wenn es stärker wird. Wir besprechen das beim nächsten Termin.',
      read: false,
    ...
    },
    {
      ...
      receiverId: patientId,
      content:
        'Ihre Übungsblätter zur progressiven Muskelentspannung sind jetzt im Materialbereich verfügbar.',
      read: true,
    ...
    },
    {
      ...
      senderId: patientId,
      receiverId: therapistId,
      content: 'Super, danke! Die Übungen helfen mir wirklich gut beim Einschlafen.',
      read: true,
...
const demoQuestionnaires = [
  {
    ...
    description: 'Standardisierter Fragebogen zur Erfassung von Depressionen',
    status: 'pending',
    createdAt: new Date(Date.now() - 86400000).toISOString(),
    questions: [
      {
        id: 'q1-1',
        text: 'Wie oft hatten Sie wenig Interesse oder Freude an Tätigkeiten?',
        type: 'scale',
        required: true,
      },
    ],
  },
  {
    ...
    description: 'Fragebogen zur Angst-Erfassung',
    status: 'completed',
    createdAt: new Date(Date.now() - 604800000).toISOString(),
    completedAt: new Date(Date.now() - 500000000).toISOString(),
    questions: [],
  },
];
...
const demoDocumentRequests = [
  {
    id: 'dr1',
    documentType: 'lab_results' as const,
    description: 'Bitte laden Sie Ihre aktuellen Blutwerte hoch.',
  ...
  },
  {
    ...
    description: 'Überweisungsschein vom Hausarzt',
  ...
  {
    id: 'dr3',
    documentType: 'medical_scan' as const,
    description: 'MRT-Aufnahmen vom Kopf',
...
const demoMaterials = [
  {
    id: 'mat1',
    title: 'Notizen für nächste Sitzung',
    content: 'Themen: Schlafprobleme, Stressbewältigung',
    type: 'note',
    createdAt: new Date(Date.now() - 86400000).toISOString(),
  },
  {
...
const demoDiaryEntries = [
  {
    ...
    anxiety_level: 3,
    stress_level: 4,
    notes: 'Heute war ein guter Tag. Atemübungen haben geholfen.',
    symptoms: ['leichte Kopfschmerzen'],
    triggers: ['Arbeitsstress'],
    activities: ['Atemübungen', 'Spaziergang'],
    medications: [{ name: 'Sertralin', dosage: '50mg', taken: true }],
  },
  {
    id: 'de2',
    ...
    anxiety_level: 6,
    stress_level: 7,
    notes: 'Stressiger Tag auf der Arbeit.',
    symptoms: ['Schlafprobleme', 'Anspannung'],
    triggers: ['Arbeit', 'Deadlines'],
    activities: ['Lesen'],
    medications: [
      { name: 'Sertralin', dosage: '50mg', taken: true },
      { name: 'Lorazepam', dosage: '0.5mg', taken: true },
    ],
  },
  {
    id: 'de3',
    ...
    anxiety_level: 2,
    stress_level: 2,
    notes: 'Ausflug in die Natur — sehr erholsam.',
    symptoms: [],
    triggers: [],
    activities: ['Wandern', 'Meditation', 'Kochen'],
    medications: [{ name: 'Sertralin', dosage: '50mg', taken: true }],
  },
  {
    id: 'de4',
    ...
    anxiety_level: 4,
    stress_level: 5,
    notes: 'Durchschnittlicher Tag. Therapieübungen gemacht.',
    symptoms: ['leichte Müdigkeit'],
    triggers: ['schlechter Schlaf'],
    activities: ['Progressive Muskelentspannung'],
    medications: [{ name: 'Sertralin', dosage: '50mg', taken: true }],
  },
  {
    id: 'de5',
    ...
    anxiety_level: 7,
    stress_level: 8,
    notes: 'Schwieriger Tag. Panikattacke am Morgen.',
    symptoms: ['Herzrasen', 'Atemnot', 'Schwindel'],
    triggers: ['Menschenmenge', 'enge Räume'],
    activities: ['Atemübungen'],
    medications: [
      { name: 'Sertralin', dosage: '50mg', taken: true },
      { name: 'Lorazepam', dosage: '0.5mg', taken: true },
    ],
...
const demoMedications = [
  ...
  },
  {
    ...
    dosage: '0.5mg',
    frequency: 'as_needed',
    frequencyDetails: 'max 2x/Woche',
    timing: [],
    prescribedBy: 'Dr. Müller',
    startDate: '2025-12-15',
    reason: 'Akute Angst',
    category: 'anxiolytic',
    notes: 'Nur bei akuter Angst',
    isActive: true,
  },
];
...
const demoExercises = [
  {
    ...
    description:
      'Anleitung nach Jacobson: Systematisches Anspannen und Entspannen der Muskelgruppen',
    category: 'relaxation',
    categoryLabel: 'Entspannung',
    instructions:
      '1. Setzen Sie sich bequem hin\n2. Spannen Sie nacheinander jede Muskelgruppe für 5 Sekunden an\n3. Lassen Sie die Spannung los und spüren Sie die Entspannung',
    frequency: 'daily',
    ...
    createdAt: new Date(Date.now() - 604800000).toISOString(),
    assignedBy: 'Dr. Müller',
  },
  {
    id: 2,
    title: 'Gedankenprotokoll',
    description: 'Notieren Sie negative Gedanken und formulieren Sie alternative Gedanken',
    category: 'cognitive_restructuring',
    categoryLabel: 'Kognitive Umstrukturierung',
    instructions:
      '1. Schreiben Sie den negativen Gedanken auf\n2. Bewerten Sie die Intensität (0-10)\n3. Finden Sie Gegenargumente\n4. Formulieren Sie einen realistischen Gedanken',
    frequency: 'daily',
  ...
  },
  {
    ...
    description: '10 Minuten tägliche Meditation mit Fokus auf den Atem',
    category: 'mindfulness',
    categoryLabel: 'Achtsamkeit',
    instructions:
      '1. Finden Sie eine ruhige Position\n2. Schließen Sie die Augen\n3. Konzentrieren Sie sich auf Ihren Atem\n4. Wenn Gedanken kommen, lassen Sie sie vorüberziehen',
    frequency: 'daily',
  ...
  {
    id: 4,
    title: 'Expositionsübung: Supermarkt',
    description: 'Gezielter Besuch im Supermarkt zur Angstbewältigung',
    category: 'exposure',
    categoryLabel: 'Exposition',
    instructions:
      '1. Gehen Sie zu einer ruhigen Zeit einkaufen\n2. Bleiben Sie mindestens 15 Minuten\n3. Notieren Sie Ihre Angst-Level (0-10) alle 5 Minuten\n4. Üben Sie Atemtechniken wenn nötig',
    frequency: 'weekly',
  ...
  {
    id: 5,
    title: 'Schlafhygiene-Protokoll',
    description:
      'Regelmäßige Schlafenszeit einhalten und Bildschirmzeit vor dem Schlafen reduzieren',
    category: 'self_care',
    categoryLabel: 'Selbstfürsorge',
    instructions:
      '1. Gehen Sie jeden Tag zur gleichen Zeit ins Bett\n2. Kein Bildschirm 1 Stunde vor dem Schlafen\n3. Notieren Sie Einschlafzeit und Aufwachzeit',
    frequency: 'daily',
...
const demoScreenings = [
  ...
  },
  {
    id: 'scr3',
    type: 'ISI',
    title: 'Schlaflosigkeits-Screening',
    score: 15,
    maxScore: 28,
    severity: 'moderate',
...
const demoTherapyNotes = [
  {
    ...
    patientId: 'demo-patient-001',
    session_date: new Date(Date.now() - 604800000).toISOString(),
    sessionDate: new Date(Date.now() - 604800000).toISOString(),
    session_number: 12,
    session_duration: 50,
    subjective:
      'Patient berichtet über verbesserten Schlaf, aber anhaltende Konzentrationsschwierigkeiten.',
    objective: 'Wacher und aufmerksamer als in letzter Sitzung. Blickkontakt gut.',
    assessment: 'Leichte Verbesserung der depressiven Symptomatik. GAD-7 Score von 12 → 9.',
    plan: 'Weiterführung der Sertralin-Medikation. Achtsamkeitsübungen intensivieren.',
    risk_assessment: 'low',
    ...
    mental_status: {
      ...
      behavior: 'kooperativ',
      speech: 'normal',
      mood: 'leicht gedrückt',
      affect: 'modulationsfähig',
      thought: 'geordnet',
      perception: 'unauffällig',
      cognition: 'orientiert',
      insight: 'gut',
      judgment: 'adäquat',
    },
    progress_rating: 4,
    goals_addressed: ['Schlafverbesserung', 'Achtsamkeit'],
    follow_up_required: true,
    next_session_planned: new Date(Date.now() + 604800000).toISOString(),
    interventions: ['Kognitive Umstrukturierung', 'Achtsamkeitsübungen'],
    diagnosis: ['F32.1'],
    homework: 'Tägliche Achtsamkeitsmeditation 10min',
    first_name: 'Max',
  ...
  },
  {
    ...
    patientId: 'demo-patient-002',
    session_date: new Date(Date.now() - 1209600000).toISOString(),
    sessionDate: new Date(Date.now() - 1209600000).toISOString(),
    session_number: 5,
    session_duration: 50,
    subjective: 'Patientin beschreibt erhöhte Angstzustände im beruflichen Umfeld.',
    objective: 'Sichtbar angespannt, häufiges Spielen mit den Händen.',
    assessment: 'Generalisierte Angststörung mit situativer Verstärkung.',
    plan: 'Expositionsübungen planen. Kognitive Umstrukturierung vertiefen.',
    ...
    progress_rating: 3,
    goals_addressed: ['Angstbewältigung', 'Exposition'],
    follow_up_required: true,
    next_session_planned: new Date(Date.now() + 604800000).toISOString(),
    interventions: ['Exposition', 'Psychoedukation'],
    diagnosis: ['F41.1'],
    homework: 'Gedankenprotokoll führen',
    first_name: 'Anna',
    last_name: 'Schmidt',
    patient: { firstName: 'Anna', lastName: 'Schmidt' },
  },
...
const demoBilling = [
  ...
  },
  {
    ...
    date: new Date(Date.now() - 2592000000).toISOString(),
    dueDate: new Date(Date.now() - 1987200000).toISOString(),
    total: 180,
    status: 'paid',
  },
];
...
const demoReports = [
  {
    id: 1,
    title: 'Behandlungsbericht Q4/2025',
    patientId: 1,
    patientName: 'Max Mustermann',
    reportType: 'treatment_summary',
    reportTypeName: 'Behandlungsbericht',
    dateFrom: '2025-10-01',
    dateTo: '2025-12-31',
    createdAt: new Date(Date.now() - 2592000000).toISOString(),
    status: 'finalized',
  ...
  {
    id: 2,
    title: 'Verlaufsbericht Januar 2026',
    patientId: 2,
    patientName: 'Anna Schmidt',
    reportType: 'progress_report',
    reportTypeName: 'Verlaufsbericht',
    dateFrom: '2026-01-01',
    dateTo: '2026-01-31',
    createdAt: new Date(Date.now() - 604800000).toISOString(),
    status: 'draft',
  ...
  {
    id: 3,
    title: 'Gutachten für Krankenkasse',
    patientId: 1,
    patientName: 'Max Mustermann',
    reportType: 'insurance_report',
    reportTypeName: 'Gutachten',
    dateFrom: '2025-06-01',
    dateTo: '2025-12-31',
...
export function getDemoResponse(method: string, url: string, userId: string): AxiosResponse | null {
  ...
  if (u.startsWith('/appointments') && m === 'POST') {
    return mockResponse(
      { id: 'demo-new-' + Date.now(), status: 'created', message: 'Termin erstellt (Demo)' },
      201
    );
  }
      ...
      templates: [
        {
          ...
          description: 'Depressions-Fragebogen',
          category: 'depression',
          questionCount: 9,
          formSchema: {
            fields: [
              {
                id: 'q1',
                type: 'scale',
                label: 'Wie oft hatten Sie wenig Interesse?',
                required: true,
              },
            ],
          },
            ...
            fields: [
              {
                id: 'q1',
                type: 'scale',
                label: 'Wie oft fühlten Sie sich nervös?',
                required: true,
              },
            ],
          },
      ...
      requests: [
        {
          id: 'qr1',
          questionnaireId: 'q1',
          templateTitle: 'PHQ-9 Depressions-Screening',
          instructions: 'Bitte beantworten Sie alle Fragen.',
          formSchema: {
            fields: [
              {
                id: 'q1',
  ...
  if (u.match(/\/questionnaires\/responses\//) && m === 'GET') {
    return mockResponse([
      {
        id: 'resp1',
        answers: [{ questionId: 'q1-1', value: 3 }],
  ...
  if (u.match(/\/(diary|symptom-diary)\/stats/)) {
    return mockResponse({
      ...
      moodTrend: 'improving',
      topSymptoms: [
        { symptom: 'Kopfschmerzen', count: 2 },
        { symptom: 'Anspannung', count: 1 },
      ],
  ...
  if (u.match(/\/medications?\/\w+\/intake-logs/) && m === 'GET') {
    return mockResponse([
      { id: 'il1', medicationId: 'med1', takenAt: new Date().toISOString(), status: 'taken' },
    ]);
  }
  ...
  if (u.match(/\/medications?\/adherence/) && m === 'GET') {
    return mockResponse({
      ...
      sideEffects: [
        { effect: 'Müdigkeit', count: 3 },
        { effect: 'Übelkeit', count: 1 },
      ],
    });
  }
  ...
  if (
    (u.startsWith('/medications') || u.startsWith('/medication')) &&
    ...
    return mockResponse([
      {
        id: 1,
        exerciseId: 2,
        exerciseTitle: 'Gedankenprotokoll',
        category: 'cognitive_restructuring',
        completed: true,
        completedAt: new Date(Date.now() - 43200000).toISOString(),
        notes: 'Gut gelaufen',
    ...
    return mockResponse([
      {
        ...
        description: 'Standardisierter Fragebogen zur Erfassung depressiver Symptome',
        category: 'Depression',
        questionCount: 9,
        maxScore: 27,
      },
      {
        id: 'GAD-7',
        name: 'GAD-7 Angst',
        description: 'Fragebogen zur Erfassung generalisierter Angststörungen',
        category: 'Angst',
        questionCount: 7,
        maxScore: 21,
      },
      ...
      demoScreenings
        ...
        .map(s => ({
          ...
          result_data: {
            ...
            severityLabel:
              s.severity === 'mild' ? 'Leicht' : s.severity === 'moderate' ? 'Mittel' : 'Keine',
          },
          created_at: s.date,
        }))
    );
  ...
  if (u.match(/\/screenings\/\w+\/questions/) && m === 'GET') {
    return mockResponse([
      {
        id: 'sq1',
        text: 'Wie oft fühlten Sie sich niedergeschlagen?',
        type: 'scale',
        min: 0,
        max: 3,
      },
    ...
    return mockResponse([
      {
        ...
        appointmentId: 1,
        type: 'email',
        scheduledFor: new Date(Date.now() + 82800000).toISOString(),
        message: 'Erinnerung: Termin morgen um 10:00',
        status: 'scheduled',
        appointmentTime: new Date(Date.now() + 86400000).toISOString(),
        otherPartyName: 'Dr. Sarah Müller',
      },
    ]);
  }
    ...
    return mockResponse([
      {
        ...
        appointmentId: 2,
        type: 'email',
        scheduledFor: new Date(Date.now() - 90000000).toISOString(),
        status: 'sent',
        appointmentTime: new Date(Date.now() - 86400000).toISOString(),
        otherPartyName: 'Dr. Sarah Müller',
      ...
      templates: [
        {
          ...
          name: 'Behandlungsbericht',
          description: 'Zusammenfassung der Behandlung',
          defaultSections: ['patientInfo', 'diagnoses', 'medications', 'recommendations'],
        },
        {
          id: 'progress_report',
          name: 'Verlaufsbericht',
          description: 'Fortschrittsbericht über den Therapieverlauf',
          defaultSections: ['patientInfo', 'therapyNotes', 'screeningResults'],
        },
        {
          id: 'insurance_report',
          name: 'Gutachten',
          description: 'Bericht für die Krankenkasse',
          defaultSections: [
            'patientInfo',
            'diagnoses',
            'medications',
  ...
  if (u.match(/\/waiting-room\/pre-session/) && m === 'GET') {
    return mockResponse({
      ...
      checklist: ['Kamera testen', 'Mikrofon testen', 'Ruhige Umgebung'],
      ready: false,
    });
  }
    ...
    return mockResponse([
      {
        id: 'n1',
        type: 'appointment',
        message: 'Termin morgen um 10:00',
        read: false,
        createdAt: new Date(Date.now() - 3600000).toISOString(),
      },
      {
        id: 'n2',
        type: 'message',
        message: 'Neue Nachricht von Dr. Müller',
        read: false,
        createdAt: new Date(Date.now() - 7200000).toISOString(),
      },
    ]);
