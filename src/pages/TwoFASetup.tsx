      ...
      <div className='max-w-md w-full bg-white rounded-lg shadow-xl p-8'>
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-600 mt-2'>
            {step === 'setup' ? t('auth:twoFAScanQR') : t('auth:twoFAEnterCode')}
          </p>
        </div>
          ...
          <form onSubmit={verifyAndEnable} className='space-y-6'>
            <div>
              ...
              <input
                ...
                autoFocus
              />
              <p className='text-sm text-gray-500 mt-2'>{t('auth:twoFAOpenApp')}</p>
            </div>
        ...
        <div className='mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg'>
          <p className='text-sm text-yellow-800'>{t('auth:twoFAImportantNotice')}</p>
        </div>
      </div>
    </div>
  );
