                    ...
                    <div className='flex items-center gap-2 mb-2'>
                      ...
                      >
                        {request.priority === 'urgent' || request.priority === 'high'
                          ? t('documents:priorityUrgent')
                          : request.priority === 'normal'
                            ? t('documents:priorityNormal')
                            : t('documents:priorityLow')}
                      </span>
                    </div>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <select
                  value={priority}
                  onChange={e =>
                    setPriority(e.target.value as NonNullable<DocumentRequest['priority']>)
                  }
                  className='w-full p-2 border border-gray-300 rounded-lg'
                >
          ...
          <div className='bg-white rounded-lg p-6 w-full max-w-2xl'>
            ...
            <div className='mb-4'>
              <p className='text-sm text-gray-600'>
                <strong>{t('documents:createRequest')}:</strong>{' '}
                {getDocumentTypeLabel(uploadingRequest.documentType)}
              </p>
          ...
          <div className='bg-white rounded-lg p-6 w-full max-w-2xl'>
            ...
            <div className='mb-4'>
              <p className='text-sm text-gray-600'>
                ...
                {getDocumentTypeLabel(reviewingRequest.documentType)}
              </p>
              <p className='text-sm text-gray-600 mb-4'>{reviewingRequest.description}</p>

              <p className='text-sm text-blue-600 mb-2'>✓ {t('documents:documentUploaded')}</p>
            </div>
