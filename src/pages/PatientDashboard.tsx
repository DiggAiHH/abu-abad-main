...
export default function PatientDashboard() {
  ...
  useEffect(() => {
    ...
    if (isDemo) {
      ...
      setAppointments([
        { id: 'demo-apt-1', therapistId: 't1', patientId: user.id, startTime: tomorrow10.toISOString(), endTime: tomorrow11.toISOString(), status: 'booked', price: 120, paymentStatus: 'completed', meetingRoomId: 'room-demo-1', therapist: { firstName: 'Sarah', lastName: 'Müller' } },
        { id: 'demo-apt-2', therapistId: 't1', patientId: user.id, startTime: nextWeek14.toISOString(), endTime: nextWeek15.toISOString(), status: 'booked', price: 120, paymentStatus: 'pending', meetingRoomId: 'room-demo-2', therapist: { firstName: 'Sarah', lastName: 'Müller' } },
      ]);
      setAvailableSlots([
        { id: 'demo-avail-1', therapistId: 't1', startTime: avail1Start.toISOString(), endTime: avail1End.toISOString(), status: 'available', price: 120, paymentStatus: 'pending', therapist: { firstName: 'Sarah', lastName: 'Müller' } },
        { id: 'demo-avail-2', therapistId: 't2', startTime: avail2Start.toISOString(), endTime: avail2End.toISOString(), status: 'available', price: 150, paymentStatus: 'pending', therapist: { firstName: 'Thomas', lastName: 'Weber' } },
      ]);
      setMessages([
        { id: 'msg-d1', senderId: 't1', receiverId: user.id, content: 'Bitte bringen Sie zum nächsten Termin Ihre Medikamentenliste mit.', read: false, createdAt: new Date(Date.now() - 7200000).toISOString(), sender: { firstName: 'Dr. Sarah', lastName: 'Müller' } },
        { id: 'msg-d2', senderId: 't1', receiverId: user.id, content: 'Ihre Übungsblätter sind bereit zum Download.', read: true, createdAt: new Date(Date.now() - 172800000).toISOString(), sender: { firstName: 'Dr. Sarah', lastName: 'Müller' } },
      ]);
      setLoading(false);
      return;
    }
